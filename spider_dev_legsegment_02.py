...
def toCompound(theObjectName):
 
    theObject = App.activeDocument().getObject(theObjectName)
    newObject = App.activeDocument().addObject("Part::Compound","Compound")
